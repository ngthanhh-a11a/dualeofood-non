...
const PromotionalBanner = () => {
    return (
        <div className="relative w-full rounded-2xl overflow-hidden bg-orange-50 border border-orange-100">
            {/* Soft decorative elements instead of glowing orbs */}
            <div className="absolute top-0 right-0 w-64 h-64 bg-orange-200/40 rounded-full -translate-y-1/2 translate-x-1/3 blur-2xl"></div>
            <div className="absolute bottom-0 left-0 w-48 h-48 bg-yellow-200/40 rounded-full translate-y-1/3 -translate-x-1/4 blur-2xl"></div>
            ...
            <div className="relative z-10 px-6 py-10 md:px-12 md:py-12 flex flex-col md:flex-row items-center gap-8 md:gap-12">
                ...
                <div className="flex-1 text-center md:text-left">
                    <div className="inline-flex items-center gap-2 bg-orange-100 text-orange-600 border border-orange-200 rounded-full px-4 py-1.5 mb-4">
                    ...
                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-black text-slate-800 leading-tight tracking-tight">
                        Ăn Ngon Miệng, <br />
                        <span className="text-orange-500">Giá Nhẹ Tênh</span>
                    </h2>
                    ...
                    <div className="mt-6">
                        <Link 
                            to="/menu" 
                            className="inline-flex items-center justify-center bg-orange-500 text-white font-bold py-3 px-8 rounded-xl hover:bg-orange-600 transition-colors shadow-sm hover:shadow-md active:scale-95"
                        >
                            Đặt Món Ngay
                        </Link>
                    </div>
                     ...
                     <div className="absolute w-56 h-32 bg-white rounded-xl shadow-lg border border-slate-100 p-5 rotate-3 hover:rotate-0 transition-transform duration-300">
                        <div className="flex justify-between items-start border-b border-dashed border-slate-200 pb-3 mb-3">
                            <div>
                                ...
                                <p className="text-2xl font-black text-orange-500">Giảm 20%</p>
                            </div>
